...
PRIVATE guint		gCartridgeWidth[CARTRIGE_TYPE_NUM] = {108, 57, 0, 74, 82, 40, 40, 108, 99, 125, 142, 41, 41, 41, 41, 103, 114, 141, 84, 89, 41, 41, 52, 52, 103, 103  };	
                                                         ...
                                                         // iP4600, iP3600
//PRIVATE guint		gCartridgeWidth[CARTRIGE_TYPE_NUM] = {108, 57, 0, 74, 82, 40, 40, 108, 99, 125, 142, 41, 41, 41, 41, 103, 114, 141, 84, 89, 41, 41, 52, 52  };	
                                                         // ip2200(black), ip2200(color), ip2200(black_hc), ip2200(color_hc), ip4200, ip6600D, ip7500, ip3300, ip100, ip2200(black_mn), ip2200(color_mn), ip90, ip90(CIL:OFF)
//PRIVATE guint		gCartridgeWidth[CARTRIGE_TYPE_NUM] = {108, 57, 0, 74, 82, 40, 40, 108, 99, 125, 142, 37, 37, 37, 37, 109, 120, 147  };	
                                                         // ip2200(black), ip2200(color), ip2200(black_hc), ip2200(color_hc), ip4200, ip6600D, ip7500
